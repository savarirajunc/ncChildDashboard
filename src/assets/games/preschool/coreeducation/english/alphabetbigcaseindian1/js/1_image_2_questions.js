//Game Title : Alphabets Mixed Case Indian CBSE
//Developer  : G.Gokul
//QC         : Sahana Ravi
...
var Learn = {	
	...
	create : function(){
        ...
        console.log(arr.sort(this.numRandomized));
		this.randAppearFun();
		this.timerFull();
	},
	...
	oncallRandomFun : function(){
		if(rand1 == arr[objectNum]){			
			arr[objectNum] = Math.floor(Math.random() * objectcount+1);
			this.oncallRandomFun();
		}
		else
		{
			...
			question.play();
			replayaudio = '';
			question.onStop.addOnce(this.replayaudiofun, this);
		}
	},
	
	    replayaudiofun : function(){
		actual_time = countNum - actual_time;
		replayaudio = 'audio/question'+'.mp3';
