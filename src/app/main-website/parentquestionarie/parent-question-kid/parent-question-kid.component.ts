...
@Component({
  selector: 'app-parent-question-kid',
  templateUrl: './parent-question-kid.component.html',
  styleUrls: ['./parent-question-kid.component.css']
})
export class ParentQuestionKidComponent implements OnInit {
  ...
  constructor(private activatedRoute:ActivatedRoute, private http:HttpClient,private mainWebsiteService:MainWebsiteService,  private parentQuestservice: ParentquestService, private el: ElementRef,private formBuilder: FormBuilder, private router:Router) {
